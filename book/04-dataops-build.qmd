...
````yaml
# filepath: /workspace/book/config/llm_data_pipeline.yaml
...
manuals = pd.DataFrame([
    {"section": "Resetting your robot's location configs", "content": "To reset your password, go to the settings page and click 'Reset Password'..."},
...
This is the format selected for the LLM exercise throughout this book. But you can chose the data format which suits your needs and contraints.
::::
...
````python
# filepath: /workspace/book/pipelines/prepare_llm_data.py
import pandas as pd
import yaml
import json
import logging
...
def load_config(config_path='config/llm_data_pipeline.yaml'):
