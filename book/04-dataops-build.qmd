...
::: {.callout-tip}
You can find the requirements, source code for the data pipeline, and helper functions [here](https://github.com/bradleyboehmke/uc-bana-7085/tree/main/DataOps).
:::
