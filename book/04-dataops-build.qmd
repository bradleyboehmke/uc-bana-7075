...
manuals = pd.DataFrame([
    {"section": "Resetting your robot's location configs", "content": "To reset your robot's location settings, go to the settings page and click 'Reset Password'..."},
...
We will now implement the pipeline in Python. Notice how each step (loading, transforming, saving) is a separate function. This modularity makes the code easier to test, debug, and maintain. We will also include logging and error handling to make the pipeline more robust.
