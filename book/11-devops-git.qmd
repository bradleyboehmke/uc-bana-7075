...
Once you have a local repository connected to a remote GitHub repository, you will need to ***push*** and ***pull*** changes between the two to keep them in sync. When you make changes to the project locally and commit them, you can push these changes to GitHub using:
