...
- Model Choice (gpt2): We are using gpt2 for this exercise because it is a foundational and well understood. At 117 million parameters, it is small enough to be fine-tuned on consumer hardware. The principles learnt while fine-tuning gpt2 are directly applicable to much larger models.
...
### 4. Reflection on Design Principles

Reflect on how this exercise connects to the principles of ModelOps and experiment tracking:
