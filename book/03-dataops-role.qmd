...
- What have you learned from initial data exploration that will inform your data strategy?
- What types of data (e.g., chat logs, support tickets, user manuals, FAQs) are most relevant for fine-tuning the LLM?
- Do you have sufficient data volume and diversity to support robust fine-tuning? If data is limited, what strategies could you use to augment or generate additional training examples?
...
- How will you handle updates to the underlying product (e.g., new robot hardware/software versions)?
- What is your plan for removing outdated or irrelevant information from the data?
...
- What mechanisms will you use to monitor data quality over time?
...
- Should this context be incorporated during model fine-tuning data, or provided dynamically at inference time via prompts?
