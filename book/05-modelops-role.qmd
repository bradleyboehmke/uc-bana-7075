...
Let us use the learning from this chapter for our AI-powered customer support assistant. At this point, we have the fine-tuning data ready. What we need to think through is how will the model training, testing, serving, monitoring and further improvement look like.
...
- Decision: Which foundation model should we use as our starting point?
...
- Decision: What fine-tuning methodology is most appropriate?
...
By addressing these ModelOps considerations systematically, we can create a robust lifecycle for our customer support assistant that ensures consistent performance and continuous improvement as business needs evolve.
...
Modern AI tools can be valuable collaborators in your system architecture planning. You don't need deep expertise in software architectures. These tools can help you explore design patterns, identify potential scaling solutions, and discover implementation approaches that might otherwise require years of specialized experience.
...
- Example: Configure GitHub Actions to automatically test, package, and deploy model updates.


By incorporating these software engineering practices alongside ModelOps principles, ML practitioners can build LLM systems that not only perform well but also operate reliably at scale.
