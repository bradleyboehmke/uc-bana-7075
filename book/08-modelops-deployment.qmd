...
The main distinction is the sheer size and resource requirements of LLMs. A traditional model like our housing price predictor might have thousands or millions of parameters. In contrast LLMs have billions of parameters and can require tens or even hundreds of gigabytes of memory just to be loaded.

This leads to many downstream challenges:
...
For example: how will you handle model updates? How does the chosen stack integrate with your existing monitoring and logging tools?
:::
...
We have talked a lot about LLMs having significantly more resource requirements during serving. Let's use a free and open-source tool to get a hands-on feel for these requirements. This will help us get a sense of these requirements in real life.
...
Can your local computer serve all of these models? As you interact with each one, what kind of TTFT and throughput do you notice? Given what you know about your computer's hardware, can you discuss what kind of hardware would be needed to serve the fine-tuned LLM in production? What if you needed to serve multiple instances of that model in parallel to support thousands of customers?
