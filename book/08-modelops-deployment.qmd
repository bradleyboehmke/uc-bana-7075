...
Can your local computer serve all of these models? As you interact with each one, what kind of TTFT and throughput do you notice? Given what you know about your computer's hardware, can you imagine what kind of hardware would be needed to serve the fine-tuned LLM in production? What if you needed to serve multiple instances of that model in parallel to support thousands of customers?
